// api결과값 받아오는 동안 발생하는 로딩으로
// 자동으로 사라지는 모달로 만들것임
const FetchingModal = () => {
    return ( 
        <div className={`fixed top-0 left-0 z-[1055] flex h-full w-full place-items
           center justify-center bg-black bg-opacity-20`}>
            <div className=" bg-white rounded-3xl opacity-100 min-w-min h-1/4 min-w
